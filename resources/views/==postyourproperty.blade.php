  ...
  <div class="dashboard crop-avatar">
    <div class="container">
      <div class="row">
		...
		<section class="green-strip-wrapper" style="background-color: #353878;">
		  <div class="container">
			<div class="row">
      ...
      <div class="row font-roboto regular brtop-10">
         <form class="form-horizontal validate err-static" role="form" method="post" action="#" title="" name="myform">
          ...
          <input type="hidden" name="id" value="<?php if(isset($data)){ ?>{{ $data[0]->id }}<?php } ?>">
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 field-wrap">
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 d-line">
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <label class="text-uppercase">Property Posted By</label><br>
                  <div class="checkbox checkbox">
                     <input id="propertyPostedByO" type="checkbox" value="owner" <?php if(isset($data)){  if($data[0]->property_posted_by == 'owner') echo "checked"; }?> name="propertyPostedBy[]">
                     <label for="propertyPostedByO"> Owner</label>
                  </div>
                  <div class="checkbox checkbox">
