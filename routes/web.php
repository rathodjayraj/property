...
use Botble\RealEstate\Http\Controllers\MyrequirementController;
use Botble\RealEstate\Http\Controllers\TestimonialsController;
use Botble\RealEstate\Http\Controllers\SpotlightController;
...
Route::group(['namespace' => 'Botble\RealEstate\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    ...
    Route::group([
		...
		Route::group(['prefix' => 'requirement', 'as' => 'requirement.'], function () {
            Route::resource('', 'RequirementController')
                ->parameters(['' => 'requirement']);
            Route::delete('items/destroy', [
                'as'         => 'deletes',
                'uses'       => 'RequirementController@deletes',
                'permission' => 'requirement.destroy',
            ]);
        });
		
		Route::group(['prefix' => 'testimonialad', 'as' => 'testimonialad.'], function () {
            Route::resource('', 'TestimonialsController')
                ->parameters(['' => 'testimonialad']);
            Route::delete('items/destroy', [
                'as'         => 'deletes',
                'uses'       => 'TestimonialsController@deletes',
                'permission' => 'testimonialad.destroy',
            ]);
        });
		
		Route::group(['prefix' => 'spotlight', 'as' => 'spotlight.'], function () {
            Route::resource('', 'SpotlightController')
                ->parameters(['' => 'spotlight']);
            Route::delete('items/destroy', [
                'as'         => 'deletes',
                'uses'       => 'SpotlightController@deletes',
                'permission' => 'spotlight.destroy',
            ]);
        });
    ...
    if (defined('THEME_MODULE_SCREEN_NAME')) {
        ...
        Route::group(['middleware' => ['account'], 'as' => 'public.account.'], function () {
            Route::group(['prefix' => 'account'], function () {
                ...
                Route::get('userlist', [
                    'as' => 'userlist',
                    'uses' => 'PublicAccountController@getuserlist',
                ]);
