...
use Botble\RealEstate\Models\Requirement;
...
use Botble\RealEstate\Repositories\Caches\RequirementCacheDecorator;
use Botble\RealEstate\Repositories\Caches\TestimonialCacheDecorator;
use Botble\RealEstate\Repositories\Caches\SpotlightCacheDecorator;
...
use Botble\RealEstate\Repositories\Eloquent\RequirementRepository;
use Botble\RealEstate\Repositories\Eloquent\TestimonialsRepository;
use Botble\RealEstate\Repositories\Eloquent\SpotlightRepository;
...
class RealEstateServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(RequirementInterface::class, function () {
            return new RequirementCacheDecorator(
                new RequirementRepository(new requirement)
            );
        });

        $this->app->bind(TestimonialsInterface::class, function () {
            return new TestimonialCacheDecorator(
                new TestimonialsRepository(new testimonials)
            );
        });

        $this->app->bind(SpotlightInterface::class, function () {
            return new SpotlightCacheDecorator(
                new SpotlightRepository(new Spotlight)
            );
        });
    ...
    public function boot()
    {
        ...
        Event::listen(RouteMatched::class, function () {
            dashboard_menu()
                ...
                ->registerItem([
                    'id'          => 'cms-plugins-real-estate-requirement',
                    'priority'    => 22,
                    'parent_id'   => null,
                    'name'        => 'Requirement',
                    'icon'        => 'fa fa-asterisk',
                    'url'         => route('requirement.index'),
                    'permissions' => ['requirement.index'],
                ])

                ->registerItem([
                    'id'          => 'cms-plugins-real-estate-testimonials',
                    'priority'    => 23,
                    'parent_id'   => null,
                    'name'        => 'Testimonial',
                    'icon'        => 'fa fa-quote-left',
                    'url'         => route('testimonialad.index'),
                    'permissions' => ['testimonialad.index'],
                ])

                ->registerItem([
                    'id'          => 'cms-plugins-real-estate-spotlight',
                    'priority'    => 23,
                    'parent_id'   => null,
                    'name'        => 'Spotlight',
                    'icon'        => 'fa fa-quote-left',
                    'url'         => route('spotlight.index'),
                    'permissions' => ['spotlight.index'],
                ]);
