...
use Botble\RealEstate\Http\Requests\RequirementRequest;
...
use Botble\RealEstate\Tables\RequirementTable;
...
class RequirementController extends BaseController
{
     ...
     */
    public function __construct(RequirementInterface $packageRepository)
    {
     ...
     * @throws \Throwable
     */
    public function index(RequirementTable $table)
    {
