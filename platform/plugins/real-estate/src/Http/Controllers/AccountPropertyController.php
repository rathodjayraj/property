...
class AccountPropertyController extends Controller
{
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        $features = DB::table('re_property_features')->where('property_id',$id)->get();

        $distance = DB::table('re_facilities_distances')->where('reference_id',$id)->get();
        
        return view('create_new', array('data' => $property,'features' => $features, 'distance' => $distance));
    }
     ...
     */
    public function update($id, AccountPropertyRequest $request, BaseHttpResponse $response,
        StorePropertyCategoryService $propertyCategoryService, SaveFacilitiesService $saveFacilitiesService) 
    {
        dd($request->all());
        $property = $this->propertyRepository->getFirstBy([
            'id'          => $id,
