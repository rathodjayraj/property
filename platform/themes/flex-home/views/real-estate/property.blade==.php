                        ...
                        <div class="row py-2">
                            <div class="col-sm-12">
                                <table class="table table-striped table-bordered">
                                    ...
                                    @endif
                                    @if ($property->ready_move)
                                    <tr>
                                        <td>{{ __('Ready Move') }}</td>
                                        <td><strong>{{ $property->ready_move }}</strong></td>
                                    </tr>
                                    @endif
                                    @if ($property->plot_area)
                                     <tr>
                                        <td>{{ __('Plot Area') }}</td>
                                        <td><strong>{{ $property->plot_area }}</strong></td>
                                    </tr>
                                    @endif
                                    @if ($property->constructed_year)
                                    <tr>
                                        <td>{{ __('Constructed Year') }}</td>
                                        <td><strong>{{ $property->constructed_year }}</strong></td>
                                    </tr>
                                    @endif
                                    @if ($property->mobile_2)
                                    <tr>
                                        <td>{{ __('phone') }}</td>
                                        <td><strong>{{ $property->mobile_2 }} <?php if($property->mobile_sms == 1) echo '<i class="fa fa-whatsapp"></i>' ?></strong></td>
                                    </tr>
                                    @endif
